...
Wilson suggests that a good practice is to create analysis friendly data. This includes tidying up your data with such things as making each column a variable, and each row an observation. 
